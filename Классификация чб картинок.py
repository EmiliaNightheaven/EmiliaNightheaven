...
import matplotlib.pyplot as plt                                 #Необходимо заранее докачать библиотеку matplotlib в Anaconda. Используется для построения изображений
import numpy as np
...
X_train = X_train[idxs]                                 #Взятие признаков по обучению только по этим индексам
